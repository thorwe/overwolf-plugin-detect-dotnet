...
char kMimeType[] = "application/x-detect-dotnet-plugin";
...
nsPluginInstanceBase* NS_NewPluginInstance(
  ...
  nsPluginInstancenpDetectDotNetPlugin* plugin =
    new nsPluginInstancenpDetectDotNetPlugin(aCreateDataStruct->instance);
...
void NS_DestroyPluginInstance(nsPluginInstanceBase * aPlugin) {
  if(aPlugin) {
    delete (nsPluginInstancenpDetectDotNetPlugin*)aPlugin;
  }
}
